...
# -*- coding: utf-8 -*-
"""
Script pour vérifier la structure de la table software_items
"""
...
def check_table_structure(db_path, table_name):
    ...
    try:
        ...
        for col in columns:
            ...
            print("| {:3} | {:20} | {:10} | {:8} | {:8} | {:8} |".format(
                cid, name, type_, type_, notnull, str(dflt_value or ""), pk
            ))
...
if __name__ == "__main__":
    db_path = "worlds.db"
    check_table_structure(db_path, "software_items")
